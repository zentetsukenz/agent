...
const { validateTestConfig } = require(path.join(
  __dirname,
...
describe("Tests Service - Unit Tests", () => {
  describe("validateTestConfig", () => {
    ...
    test("should allow optional timeout field", () => {
      const validConfig = {
        duration: 30,
        connections: 10,
        timeout: 120,
    ...
    test("should validate timeout is a number if provided", () => {
      const invalidConfig = {
        duration: 30,
        connections: 10,
    ...
    test("should validate timeout is between 1 and 600", () => {
      const invalidConfig = {
        duration: 30,
        connections: 10,
        timeout: 0,
    ...
    test("should validate timeout max value", () => {
      const invalidConfig = {
        duration: 30,
        connections: 10,
        timeout: 601,
