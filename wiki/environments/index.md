...
type: Index
title: Environments
description: Development environment setup and tools
---

# Environments Index

Development environment setup and tools for agent framework development.

| Environment | Summary |
|-------------|---------|
| [Development Servers](dev-servers.md) | Starting, stopping, and verifying development servers |
| [Domain Docs](domain-docs.md) | Where a project's glossary and ADRs live; the shared path-resolution order and single/multi-context file layout the domain skills consume |
...
| [OpenCode](opencode.md) | OpenCode's customization primitives (AGENTS.md, primary/subagent agents, commands, skills, permissions) — the authoritative reference for the OpenCode adapter's `setup.md` |
