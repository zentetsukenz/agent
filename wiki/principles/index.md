...
type: Index
title: Principles
description: Core philosophy and decision-making frameworks
---
...
| Principle | Summary |
|-----------|---------|
| [Wisdom](wisdom.md) | Core principles that guide decisions across all agents |
| [Context-First Philosophy](context-first.md) | How to manage context as a first-class resource in agent design |
