...
> [handoff](../../SKILLS/preservation/handoff/SKILL.md) skill has always enforced, now scoped to a seam.
...
keep their distinct *strategies* — `handoff` COMPRESSES, `session-bootstrap` SELECTS,
...
- [handoff](../../SKILLS/preservation/handoff/SKILL.md) — the PRODUCE adapter (writes a seam artifact).
