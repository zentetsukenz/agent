...
- **Grilling** (HITL): Conversation via the [grill-me](../../discovery/grill-me/SKILL.md) and [domain-model](../domain-model/SKILL.md) skills, one question at a time. The default case.
...
1. **Name the destination.** Run a [grill-me](../../discovery/grill-me/SKILL.md) and [domain-model](../domain-model/SKILL.md) session to pin down what this map is finding its way to — the spec, decision, or change. The destination fixes the scope, so it's settled first.
...
3. Resolve it — **zoom as needed**: fetch the full body of any related or closed ticket on demand; invoke the skills the `## Notes` block names. If in doubt, use [grill-me](../../discovery/grill-me/SKILL.md) and [domain-model](../domain-model/SKILL.md).
