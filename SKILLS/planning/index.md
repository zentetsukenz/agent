...
description: Skills for decomposing a shaped solution into risk-ordered, dispatchable tasks
---
| Skill | Description |
|---|---|
| [task-sizing](task-sizing/SKILL.md) | Estimate and size tasks before committing |
| [dispatch-context](dispatch-context/SKILL.md) | Engineer minimal context for within-stage peer delegation, parked in the ledger's organized `working/` lane |
