...
description: Verify UI changes visually by delegating screenshots and analysis to visual-qa, keeping image bytes out of the main context while checking layout, styling, responsiveness, and polish before claiming UI work is complete.
---
