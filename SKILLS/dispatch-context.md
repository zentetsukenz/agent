...
Use [task-sizing.md](task-sizing.md) to confirm dispatch is appropriate.
...
- [task-sizing.md](task-sizing.md) — Decide whether to dispatch
- [checkpoint.md](checkpoint.md) — Uses similar compression
